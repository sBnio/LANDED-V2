    ...
    <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 pb-32">
      ...
      <div className="mb-8">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <div className="bg-amber-600 rounded-2xl p-5 sm:p-6 text-white shadow-xl shadow-amber-600/20 flex flex-col justify-center">
            <span className="text-xs font-black uppercase tracking-widest text-amber-200 mb-1">Still To Pay</span>
            <span className="text-3xl sm:text-4xl font-black">{formatAmt(stillToPay)} <span className="text-base sm:text-lg font-bold text-amber-300">{currencyCode}</span></span>
          </div>
      ...
      <div className="space-y-8">
            ...
            <div className="py-4 first:pt-0 last:pb-0 flex flex-col sm:flex-row sm:items-start justify-between gap-4">
              <div className="flex-1">
                ...
                <label className="inline-flex items-center gap-2 mt-2 cursor-pointer group">
                  <div className="w-5 h-5 rounded border border-slate-300 flex items-center justify-center shrink-0 group-hover:border-amber-500 transition-colors bg-white">
              ...
              <div className="flex-1">
                ...
                <div className="mt-3 space-y-2">
                  <label className="flex items-center gap-3 cursor-pointer group w-max">
                    <div className={cn("w-4 h-4 rounded-full border-2 flex items-center justify-center transition-colors", medicalStatus === "need" ? "border-amber-600" : "border-slate-300")}>
                      {medicalStatus === "need" && <div className="w-2 h-2 rounded-full bg-amber-600" />}
                    </div>
                  ...
                  <label className="flex items-center gap-3 cursor-pointer group w-max">
                    <div className={cn("w-4 h-4 rounded-full border-2 flex items-center justify-center transition-colors", medicalStatus === "done" ? "border-amber-600" : "border-slate-300")}>
                      {medicalStatus === "done" && <div className="w-2 h-2 rounded-full bg-amber-600" />}
                    </div>
                  ...
                  <label className="flex items-center gap-3 cursor-pointer group w-max">
                    <div className={cn("w-4 h-4 rounded-full border-2 flex items-center justify-center transition-colors", medicalStatus === "exempt" ? "border-amber-600" : "border-slate-300")}>
                      {medicalStatus === "exempt" && <div className="w-2 h-2 rounded-full bg-amber-600" />}
                    </div>
        ...
        <section className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
          ...
          <div className="p-5 sm:p-6 border-b border-slate-100 bg-amber-50/30">
        ...
        <section className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
          ...
          >
            ...
            <div className="w-10 h-10 rounded-full bg-white border border-slate-200 flex items-center justify-center shrink-0 group-hover:bg-amber-50 transition-colors">
          ...
          {!showOptionals ? (
            <div className="p-6 text-center bg-white">
               <button 
                 ...
                 className="inline-flex items-center gap-2 font-bold text-amber-600 hover:text-amber-700 hover:bg-amber-50 px-4 py-2 rounded-xl transition-colors"
               >
            ...
            <div className="p-5 sm:p-6 divide-y divide-slate-100 text-sm">
              ...
              {/* Health Insurance */}
              <div className={cn("py-4 first:pt-0 flex flex-col sm:flex-row sm:items-start justify-between gap-4 transition-colors rounded-xl p-3", incHealth ? "bg-amber-50/50" : "")}>
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <h3 className={cn("font-bold", incHealth ? "text-amber-900" : "text-slate-900")}>Health Insurance</h3>
                    <div className="group relative hidden sm:inline-block">
                      <Info className="w-4 h-4 text-slate-400 cursor-help hover:text-slate-600 transition-colors" />
                      <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-64 p-3 bg-slate-800 text-white text-xs font-medium rounded-xl shadow-xl opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-10">
                  ...
                  <label className="flex items-center gap-2 mt-2 cursor-pointer group w-max">
                    <div className="w-5 h-5 rounded border border-slate-300 flex items-center justify-center shrink-0 group-hover:border-amber-500 transition-colors bg-white">
                      ...
                      {incHealth && <CheckCircle2 className="w-4 h-4 text-amber-600" />}
                    </div>
                    <span className="text-sm text-slate-600 font-medium">Include in my estimate</span>
                  </label>
                </div>
                <div className="sm:text-right shrink-0">
                  <span className={cn("font-black text-base transition-colors block", incHealth ? "text-amber-900" : "text-slate-700")}>
              ...
              {/* Airport Transfer */}
              <div className={cn("py-4 flex flex-col sm:flex-row sm:items-start justify-between gap-4 transition-colors rounded-xl p-3", incAirport ? "bg-amber-50/50" : "")}>
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <h3 className={cn("font-bold", incAirport ? "text-amber-900" : "text-slate-900")}>Airport Transfer (Arrival)</h3>
                    <div className="group relative hidden sm:inline-block">
                      <Info className="w-4 h-4 text-slate-400 cursor-help hover:text-slate-600 transition-colors" />
                      <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-64 p-3 bg-slate-800 text-white text-xs font-medium rounded-xl shadow-xl opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-10">
                  ...
                  <label className="flex items-center gap-2 mt-2 cursor-pointer group w-max">
                    <div className="w-5 h-5 rounded border border-slate-300 flex items-center justify-center shrink-0 group-hover:border-amber-500 transition-colors bg-white">
                      ...
                      {incAirport && <CheckCircle2 className="w-4 h-4 text-amber-600" />}
                    </div>
                    <span className="text-sm text-slate-600 font-medium">Include in my estimate</span>
                  </label>
                </div>
                <div className="sm:text-right shrink-0">
                  <span className={cn("font-black text-base transition-colors block", incAirport ? "text-amber-900" : "text-slate-700")}>
              ...
              {/* Groceries */}
              <div className={cn("py-4 flex flex-col sm:flex-row sm:items-start justify-between gap-4 transition-colors rounded-xl p-3", incGroceries ? "bg-amber-50/50" : "")}>
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <h3 className={cn("font-bold", incGroceries ? "text-amber-900" : "text-slate-900")}>Initial Groceries & Home Setup</h3>
                    <div className="group relative hidden sm:inline-block">
                      <Info className="w-4 h-4 text-slate-400 cursor-help hover:text-slate-600 transition-colors" />
                      <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-64 p-3 bg-slate-800 text-white text-xs font-medium rounded-xl shadow-xl opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-10">
                  ...
                  <label className="flex items-center gap-2 mt-2 cursor-pointer group w-max">
                    <div className="w-5 h-5 rounded border border-slate-300 flex items-center justify-center shrink-0 group-hover:border-amber-500 transition-colors bg-white">
                      ...
                      {incGroceries && <CheckCircle2 className="w-4 h-4 text-amber-600" />}
                    </div>
                    <span className="text-sm text-slate-600 font-medium">Include in my estimate</span>
                  </label>
                </div>
                <div className="sm:text-right shrink-0">
                  <span className={cn("font-black text-base transition-colors block", incGroceries ? "text-amber-900" : "text-slate-700")}>
              ...
              {/* Textbooks */}
              <div className={cn("py-4 flex flex-col sm:flex-row sm:items-start justify-between gap-4 transition-colors rounded-xl p-3", incTextbooks ? "bg-amber-50/50" : "")}>
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <h3 className={cn("font-bold", incTextbooks ? "text-amber-900" : "text-slate-900")}>Textbooks & Stationery <span className="font-medium text-slate-500">(First Semester)</span></h3>
                    <div className="group relative hidden sm:inline-block">
                      <Info className="w-4 h-4 text-slate-400 cursor-help hover:text-slate-600 transition-colors" />
                      <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-64 p-3 bg-slate-800 text-white text-xs font-medium rounded-xl shadow-xl opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-10">
                  ...
                  <label className="flex items-center gap-2 mt-2 cursor-pointer group w-max">
                    <div className="w-5 h-5 rounded border border-slate-300 flex items-center justify-center shrink-0 group-hover:border-amber-500 transition-colors bg-white">
                      ...
                      {incTextbooks && <CheckCircle2 className="w-4 h-4 text-amber-600" />}
                    </div>
                    <span className="text-sm text-slate-600 font-medium">Include in my estimate</span>
                  </label>
                </div>
                <div className="sm:text-right shrink-0">
                  <span className={cn("font-black text-base transition-colors block", incTextbooks ? "text-amber-900" : "text-slate-700")}>
              ...
              {/* Laptop */}
              <div className={cn("py-4 last:pb-0 flex flex-col sm:flex-row sm:items-start justify-between gap-4 transition-colors rounded-xl p-3", incLaptop ? "bg-amber-50/50" : "")}>
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <h3 className={cn("font-bold", incLaptop ? "text-amber-900" : "text-slate-900")}>Laptop / Study Equipment</h3>
                    <div className="group relative hidden sm:inline-block">
                      <Info className="w-4 h-4 text-slate-400 cursor-help hover:text-slate-600 transition-colors" />
                      <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-64 p-3 bg-slate-800 text-white text-xs font-medium rounded-xl shadow-xl opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-10">
                  ...
                  <label className="flex items-center gap-2 mt-2 cursor-pointer group w-max">
                    <div className="w-5 h-5 rounded border border-slate-300 flex items-center justify-center shrink-0 group-hover:border-amber-500 transition-colors bg-white">
                      ...
                      {incLaptop && <CheckCircle2 className="w-4 h-4 text-amber-600" />}
                    </div>
                    <span className="text-sm text-slate-600 font-medium">I still need to buy a laptop</span>
                  </label>
                </div>
                <div className="sm:text-right shrink-0">
                  <span className={cn("font-black text-base transition-colors block", incLaptop ? "text-amber-900" : "text-slate-700")}>
      ...
      <div className="mt-12 mb-8 print:hidden">
        <div className="flex flex-col sm:flex-row items-center gap-4">
          <button
            onClick={handleCopy}
            className="w-full sm:w-auto flex-1 bg-amber-600 hover:bg-amber-700 text-white font-bold text-sm h-14 rounded-xl flex items-center justify-center gap-2 transition-all active:scale-[0.98] shadow-lg shadow-amber-200"
          >
